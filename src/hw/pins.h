...
#elif defined(BOARD_XUEERSI_ESP32)
  #include "../boards/board_xueersi_esp32.h"
#else
  #error "No board defined. Add -DBOARD_WAVESHARE_ESP32S3_TOUCH_AMOLED_1_8, _1_75C, _ESP32C6_TOUCH_AMOLED_2_16, _ESP32S3_TOUCH_AMOLED_2_16, or _XUEERSI_ESP32 to build_flags in platformio.ini."
#endif
